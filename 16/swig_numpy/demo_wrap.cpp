...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_drange(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:drange",&obj0)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
...
SWIGINTERN PyObject *_wrap_rot2d(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double (*arg1)[3] ;
  double arg2 ;
  PyObject *array1 = NULL ;
  ...
  
  {
    ...
    if (!array1) SWIG_fail;
    arg1 = (double (*)[3]) array_data(array1);
  }
  if (!PyArg_ParseTuple(args,(char *)"O:rot2d",&obj0)) SWIG_fail;
  ecode2 = SWIG_AsVal_double(obj0, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "rot2d" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  rot2d((double (*)[3])arg1,arg2);
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj,array1);
  }
...
SWIGINTERN PyObject *_wrap_sum_power(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:sum_power",&obj0)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  result = (double)sum_power(arg1,arg2);
...
SWIGINTERN PyObject *_wrap_power(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:power",&obj0)) SWIG_fail;
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"drange", _wrap_drange, METH_VARARGS, NULL},
	 { (char *)"rot2d", _wrap_rot2d, METH_VARARGS, NULL},
	 { (char *)"sum_power", _wrap_sum_power, METH_VARARGS, NULL},
