...
/*-----------------------------------------------
              @(target):= _nlms_swig.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__nlms_swig

#else
#  define SWIG_init    init_nlms_swig

#endif
#define SWIG_name    "_nlms_swig"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_cnlms(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:cnlms",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "cnlms" "', argument " "7"" of type '" "double""'");
  } 
  ...
  cnlms(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"cnlms", _wrap_cnlms, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
